...
<style>
    ...
    .inv-tbl thead th { color: #fff !important; font-weight: 600; font-size: .75rem;
        ...
        padding: .85rem 1rem; background: transparent !important;
        text-align: center; vertical-align: middle; white-space: nowrap; }
    .inv-tbl tbody td { border-color: #f1f3f5 !important; padding: .75rem 1rem;
        vertical-align: middle; color: #212529; font-size: .9rem; text-align: center; }
        ...
        <div class="mt-5">
            ...
            <div class="inv-page-header d-flex align-items-center gap-3 mb-4">
                ...
                <div class="d-flex gap-2 align-items-center">
                    <form class="d-flex gap-1 align-items-center" id="search-form"
                    ...
                    <a class="btn btn-light fw-semibold" href="#" data-bs-toggle="modal" data-bs-target="#createUserModal">
