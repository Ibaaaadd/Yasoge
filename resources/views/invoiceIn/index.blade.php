                            ...
                            <div class="row g-2 align-items-end">
                                <div class="col-12 col-sm-auto">
                                    <label class="form-label mb-1"
                                        style="font-size:.78rem;font-weight:600;text-transform:uppercase;letter-spacing:.05em;color:#555;">
                                        <i class="fas fa-search me-1"></i> Cari
                                    </label>
                                    <input type="text" id="search-orders" class="form-control form-control-sm w-100"
                                        placeholder="ID Invoice..." style="min-width:160px;">
                                </div>
                                <div class="col-12 col-sm-auto">
                                    <label class="form-label mb-1"
                                        style="font-size:.78rem;font-weight:600;text-transform:uppercase;letter-spacing:.05em;color:#555;">
                                    ...
                                    <input type="date" name="date_from" id="date_from"
                                        class="form-control form-control-sm w-100" value="{{ $dateFrom ?? '' }}">
                                </div>
                                <div class="col-12 col-sm-auto">
                                    <label class="form-label mb-1"
                                        style="font-size:.78rem;font-weight:600;text-transform:uppercase;letter-spacing:.05em;color:#555;">
                                    ...
                                    <input type="date" name="date_to" id="date_to"
                                        class="form-control form-control-sm w-100" value="{{ $dateTo ?? '' }}">
                                </div>
                                <div class="col-12 col-sm-auto d-flex gap-2 flex-wrap">
                                    ...
                                    <a href="{{ route('invoiceIn.index') }}" class="btn btn-sm btn-secondary px-3"
                        ...
                        if (searchInput) {
                            searchInput.addEventListener('input', function() {
                                ...
                                document.querySelectorAll('tbody tr').forEach(row => {
                                    ...
                                    if (cell) {
                                        row.style.display = cell.textContent.toLowerCase().includes(q) ? '' :
                                            'none';
                                    }
                                });
                            });
                            ...
                            <div class="app-card-body">
                                <div class="table-responsive" style="padding: 15px">
                                        ...
                                        <tbody>
                                            @foreach ($invoiceIn as $index => $invoice)
                                                <tr class="text-center">
                                                    ...
                                                    <td class="cell" style="white-space:nowrap;">{{ $invoice->nomor }}
                                                    </td>
                                                    <td class="cell">
                                                    ...
                                                    <td class="cell">
                                                        <a class="btn btn-sm btn-outline-primary px-3"
                                                            ...
                                                            data-bs-target="#invoiceModal-{{ $invoice->id }}"><i
                                                                class="fas fa-eye me-1"></i>Lihat</a>
                                                    </td>
                                                    <td class="cell" style="white-space:nowrap;">
                                                        <a href="{{ route('invoiceIn.print', $invoice->id) }}"
                                    ...
                                    <style>
                                        ...
                                        .inv-modal-tbl thead tr {
                                            background: linear-gradient(90deg, #1a68d1, #5ba8ff);
                                        }

                                        .inv-modal-tbl thead th {
                                        ...
                                        .inv-modal-tbl tbody td {
                                            padding: .7rem 1rem;
                                            border-color: #e4eefb !important;
                                            font-size: .9rem;
                                        }

                                        .inv-modal-tbl tbody tr:nth-child(even) {
                                            background: #f5f9ff;
                                        }
                                        ...
                                        #invoiceModal-{{ $invoice->id ?? '' }} .modal-content {
