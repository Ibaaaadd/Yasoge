...
<style>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="inv-table-wrap">
                                    <table class="table inv-table">
                                        <thead>
                                            <tr>
                                                <th style="width:42%">Sepatu &amp; Stok Saat Ini</th>
                                                    ...
                                                    <select name="items[0][sepatu_id]"
                                                        ...
                                                        @foreach ($sepatuItems as $sepatu)
                                                            <option value="{{ $sepatu->id }}"
                                                                data-price="{{ $sepatu->harga }}">{{ $sepatu->kode }} (Stok: {{ $sepatu->current_stock ?? 0 }})</option>
                                                        @endforeach
                                                    </select>
                                                </td>
    ...
    <script>
        ...
        // Rebuild this row's dropdown: completely remove items already used in other rows
